export const projects = [
  {
    name: "CubiCode",
    featured: true,
    tagline: "A full-stack 3D coding platform",
    description: "An immersive web-based platform that combines a 3D interactive environment with a full-featured code editor. Built for developers who want a unique coding experience with real-time collaboration features.",
    architecture: "Built with a monorepo architecture, CubiCode uses WebSockets for real-time collaboration, WebAssembly for sandboxed code execution, and Three.js for the 3D environment layer.",
    techStack: ["React", "Node.js", "MongoDB", "Express", "Three.js", "WebSockets"],
    features: [
      "Real-time collaborative editing with WebSockets",
      "3D interactive coding environment",
      "Sandboxed code execution via WebAssembly",
  ...
  {
    name: "Space Shooter",
    tagline: "Vertical scrolling space shooter",
    description: "A classic space shooter game with multiple levels, power-ups, and enemy patterns. Built using Java AWT and Swing.",
